...
Our first experiment aimed to determine whether genes in a disease-relevant lipid vesicle (LV) could represent potential therapeutic targets.
To achieve this, the initial step was to obtain a set of genes strongly associated with a phenotype of interest.
We performed a fluorescence-based CRISPR-Cas9 screen in the HepG2 cell line and identified 462 genes associated with lipid regulation ([Methods](#sec:methods:crispr)).
From these, we selected two high-confidence gene sets that either caused a decrease or increase in lipids: a lipid-decreasing gene set with eight genes: *BLCAP*, *FBXW7*, *INSIG2*, *PCYT2*, *PTEN*, *SOX9*, *TCF7L2*, *UBE2J2*; and a lipid-increasing gene set with six genes: *ACACA*, *DGAT2*, *HILPDA*, *MBTPS1*, *SCAP*, *SRPR* (Supplementary Data 2).
